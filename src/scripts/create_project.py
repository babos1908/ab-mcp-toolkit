...
#     (Original behavior of this script.)
#   - mode="name": ask CODESYS's ScriptEngine to instantiate a registered
#     template by TEMPLATE_NAME directly at PROJECT_FILE_PATH. Needed for
#     templates that live inside the CODESYS package manager (no free-
#     standing .project file on disk for "path" mode to copy). Ported
#     2026-06-29 from upstream a081e7cb; low-risk (creates a new project,
#     doesn't touch existing ones), no online dependency.
