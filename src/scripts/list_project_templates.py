...
#      by package installers (e.g. a vendor's device package), which don't
#      necessarily exist as free-standing .project files.
...
#
# Ported 2026-06-29 from upstream a081e7cb. Purely read-only, no online
...
try:
    ...
    # Devices/ holds device packages; some vendor packages drop .project
    # templates inside their device subtree. We don't walk all entries --
    # limit to one level deep on each device to keep this fast.
